                    ...
                    <div class="p-8">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <p class="text-xs font-bold text-zinc-400 uppercase tracking-widest">Sedan Hiệu Năng Cao
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="p-8">
                        <div class="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <p class="text-xs font-bold text-zinc-400 uppercase tracking-widest">Luxary Electric
                                    Sedan</p>
                            </div>
                        </div>
                        <div class="space-y-3 mb-8">
