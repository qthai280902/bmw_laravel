    ...
    <body class="bg-zinc-950 font-sans text-zinc-100 antialiased selection:bg-[#1C69D4] selection:text-white" x-data="{ sidebarOpen: false }">
        @php
            $sectionLabels = [
                ...
                'ai-conversations' => 'Lịch sử trợ lý AI',
                'users' => 'Nhân sự',
        ...
        <div class="min-h-screen bg-[radial-gradient(circle_at_top_right,rgba(28,105,212,0.18),transparent_30rem),radial-gradient(circle_at_bottom_left,rgba(112,167,255,0.08),transparent_28rem),linear-gradient(180deg,#09090b_0%,#000_100%)]">
            <div
                x-show="sidebarOpen"
            ...
            <aside
                ...
                class="fixed inset-y-0 left-0 z-50 flex w-72 flex-col border-r border-white/10 bg-zinc-950/92 shadow-2xl shadow-black/60 backdrop-blur-2xl transition-transform duration-300 lg:translate-x-0"
            >
                <div class="border-b border-white/10 bg-black/30 px-6 py-6">
                    <div class="flex items-center justify-between gap-4">
                        <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-black uppercase tracking-[0.22em] text-white">BMW Admin</p>
                                <p class="mt-1 text-[9px] font-black uppercase tracking-[0.2em] text-[#70A7FF]">Showroom CRM</p>
                            </div>
                        </a>
                ...
                <nav class="scrollbar-none flex-1 space-y-5 overflow-y-auto overscroll-contain px-3 py-4 [mask-image:linear-gradient(to_bottom,transparent,black_1rem,black_calc(100%_-_1rem),transparent)]">
                    <section>
                        ...
                        <div class="space-y-1">
                            ...
                            <x-admin.sidebar-link :href="route('admin.ai-conversations.index')" :active="request()->routeIs('admin.ai-conversations.*')">
                                <span class="flex items-center gap-3">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h8M8 14h5M5 5h14v11H8l-3 3V5z" />
                                    </svg>
                                    Lịch sử trợ lý AI
                                </span>
                            </x-admin.sidebar-link>
                ...
                <header class="sticky top-0 z-30 border-b border-white/10 bg-black/70 backdrop-blur-xl">
                    <div class="flex min-h-20 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
                        <div class="flex min-w-0 items-center gap-4">
                            ...
                            <div class="min-w-0">
                                <p class="text-[9px] font-black uppercase tracking-[0.28em] text-[#70A7FF]">Cổng quản trị</p>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex items-center gap-2 border border-emerald-500/20 bg-emerald-500/5 px-3 py-2">
                                ...
                                <span class="text-[9px] font-black uppercase tracking-[0.2em] text-emerald-400">System live</span>
                            </div>
                        </div>
                    </div>
                </header>
