<x-app-layout>
    <x-slot name="header">
        ...
        <p class="text-zinc-500 mt-2 font-medium uppercase text-xs tracking-widest italic">Quản lý định danh và bảo mật tài khoản cá nhân.</p>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="md:col-span-1">
                    <h3 class="text-xs font-black uppercase tracking-[0.3em] text-[#1C69D4] mb-2 italic underline decoration-2 underline-offset-8 decoration-[#1C69D4]/30">Profile Information</h3>
            ...
            <div class="border-t border-zinc-900 pt-12 grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="md:col-span-1">
                    <h3 class="text-xs font-black uppercase tracking-[0.3em] text-[#1C69D4] mb-2 italic underline decoration-2 underline-offset-8 decoration-[#1C69D4]/30">Security Credentials</h3>
            ...
            <div class="border-t border-zinc-900 pt-12 grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="md:col-span-1">
                    <h3 class="text-xs font-black uppercase tracking-[0.3em] text-rose-600 mb-2 italic underline decoration-2 underline-offset-8 decoration-rose-600/30">Termination Zone</h3>
