<x-admin-layout>
    <x-admin.page-header
        ...
        title="Cơ sở dữ liệu"
        accent="Khách hàng"
        description="Hệ thống CRM tổng hợp dữ liệu khách hàng từ các lượt tương tác và lịch hẹn."
    >
        <x-slot name="metric">
            <p class="text-[10px] font-black uppercase tracking-[0.22em] text-zinc-500">Tổng khách hàng</p>
            <p class="mt-1 text-2xl font-black text-white">{{ $customers->total() }}</p>
        </x-slot>
    </x-admin.page-header>
                    ...
                    @forelse($customers as $customer)
                        <tr class="group hover:bg-zinc-800/30 transition-all duration-300">
                            ...
                            <td class="px-8 py-6 text-center">
                                <div class="inline-flex items-center gap-2 px-3 py-1 bg-zinc-950 border border-zinc-800">
